...
export const t: Dict = {
  ...
  "project.notFound.title": { en: "Project Not Found", ar: "المشروع غير موجود" },
  "project.detail.brief": { en: "Project Brief", ar: "نبذة عن المشروع" },
  "project.detail.client": { en: "Client", ar: "العميل" },
  "project.detail.db": { en: "Database Engine", ar: "محرك قاعدة البيانات" },
  "project.detail.status": { en: "Launch Status", ar: "حالة الإطلاق" },
  "project.detail.continue": { en: "Continue Exploring", ar: "تابع الاستكشاف" },
  "project.detail.visit": { en: "Visit Live Site", ar: "زيارة الموقع" },
  "project.detail.source": { en: "View Source Code", ar: "عرض الكود المصدري" },
  "project.detail.prev": { en: "Previous Project", ar: "المشروع السابق" },
  "project.detail.next": { en: "Next Project", ar: "المشروع التالي" },
  "project.detail.back": { en: "Back to Projects", ar: "العودة للمشاريع" },
  "project.detail.backAll": { en: "Back to all projects", ar: "العودة إلى كل المشاريع" },
  "project.detail.arch": { en: "Architecture & Tech", ar: "البنية والتقنيات" },
